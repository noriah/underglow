...
#define SECTION_LEFT_DIRECTION SECTION_DIRECTION_BACKWARD
#define SECTION_LEFT_INDEX 0
// left back
#define SECTION_LEFT_BACK_SIZE STRIP_LEFT_SIZE / 2
#define SECTION_LEFT_BACK_INDEX SECTION_LEFT_INDEX
// left front
#define SECTION_LEFT_FRONT_SIZE STRIP_LEFT_SIZE - SECTION_LEFT_BACK_SIZE
#define SECTION_LEFT_FRONT_INDEX \
  SECTION_LEFT_BACK_INDEX + SECTION_LEFT_BACK_SIZE

// ---------------------
// front strip
// ---------------------

#define SECTION_FRONT_DIRECTION SECTION_DIRECTION_FORWARD
#define SECTION_FRONT_INDEX SECTION_LEFT_INDEX + STRIP_LEFT_SIZE
// front left
#define SECTION_FRONT_LEFT_SIZE STRIP_FRONT_SIZE / 2
#define SECTION_FRONT_LEFT_INDEX SECTION_FRONT_INDEX
// front right
#define SECTION_FRONT_RIGHT_SIZE STRIP_FRONT_SIZE - SECTION_FRONT_LEFT_SIZE
#define SECTION_FRONT_RIGHT_INDEX \
  SECTION_FRONT_LEFT_INDEX + SECTION_FRONT_LEFT_SIZE

// ---------------------
// right strip
// ---------------------

#define SECTION_RIGHT_DIRECTION SECTION_DIRECTION_FORWARD
#define SECTION_RIGHT_INDEX SECTION_FRONT_INDEX + STRIP_FRONT_SIZE
// right front
#define SECTION_RIGHT_FRONT_SIZE STRIP_RIGHT_SIZE / 2
#define SECTION_RIGHT_FRONT_INDEX SECTION_RIGHT_INDEX
// right back
#define SECTION_RIGHT_BACK_SIZE STRIP_RIGHT_SIZE - SECTION_RIGHT_FRONT_SIZE
#define SECTION_RIGHT_BACK_INDEX \
  SECTION_RIGHT_FRONT_INDEX + SECTION_RIGHT_FRONT_SIZE

// ---------------------
// back strip
// ---------------------

#define SECTION_BACK_DIRECTION SECTION_DIRECTION_BACKWARD
#define SECTION_BACK_INDEX SECTION_RIGHT_INDEX + STRIP_RIGHT_SIZE
// back right
#define SECTION_BACK_RIGHT_SIZE STRIP_BACK_SIZE / 2
#define SECTION_BACK_RIGHT_INDEX SECTION_BACK_INDEX
// back left
#define SECTION_BACK_LEFT_SIZE STRIP_BACK_SIZE - SECTION_BACK_RIGHT_SIZE
#define SECTION_BACK_LEFT_INDEX \
  SECTION_BACK_RIGHT_INDEX + SECTION_BACK_RIGHT_SIZE
...
// ---------------------
#define SIDE_LEFT 0
#define SIDE_LEFT_SIZE \
  SECTION_FRONT_LEFT_SIZE + STRIP_LEFT_SIZE + SECTION_BACK_LEFT_SIZE
...
// ---------------------
#define SIDE_RIGHT 1
#define SIDE_RIGHT_SIZE \
  SECTION_FRONT_RIGHT_SIZE + STRIP_RIGHT_SIZE + SECTION_BACK_RIGHT_SIZE
...
// front
#define END_FRONT_SIZE \
  SECTION_LEFT_FRONT_SIZE + STRIP_FRONT_SIZE + SECTION_RIGHT_FRONT_SIZE
#define END_FRONT_INDEX SECTION_LEFT_FRONT_INDEX

// end
#define END_BACK_SIZE \
  SECTION_LEFT_BACK_SIZE + STRIP_BACK_SIZE + SECTION_RIGHT_BACK_SIZE
